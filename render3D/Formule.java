...
public class Formule {
    ...
    public static int[] conv_iso(int centro[], double p3d[], int zoom) {
        int p2d[] = new int[2];
    ...
    public static int[] conv_cav(int centro[], double p3d[], int zoom){
        int p2d[] = new int[2];
    ...
    */
    public static ArrayList<double[][]> letturaFile() {
        ...
        ArrayList<String> triangoli = new ArrayList<String>(); //lista di stringhe che contiene i triangoli della figura;
                                                                //0/0/0 1/1/1 2/2/2
        try {
            BufferedReader br = new BufferedReader(new FileReader("Car.obj")); //apertura file .obj;
            String riga;       
